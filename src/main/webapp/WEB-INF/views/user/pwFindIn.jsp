...
<style>
	...
	/* sweetalert */
	.swal-button{background-color:#f5bf25;}
	.swal-button:hover{background-color:#f5bf25 !important;}
			...
			$.ajax({
				...
				success: (result) => {
						...
						$('#ok').on('click',()=> {
							...
							else $('#errorCode').text('인증번호가 맞지않습니다');
						})
					},
				error: (xhr) => $('#errorEmail').text('아이디와 이메일이 일치하지 않습니다')
			})
				...
				<div class="pwFind">
					<form action="#">
						...
						<table>
							<tr class="text">
								<th><span>*</span> 아이디</th>
								<td><input type="text" id="userId"/>&nbsp;<span id="errorMsg" style="color:red;"></span></td>
							</tr>
							<tr class="text">
								<th><span>*</span> 이메일</th>
								<td>
							...
							<tr class="text">
								...
								<td>
									<input type="number" id="code" min="0" maxlength="6" oninput="maxLengthCheck(this)"/>&nbsp;
