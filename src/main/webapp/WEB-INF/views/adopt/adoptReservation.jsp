...
<style>
	...
	.review .dogView{width:90%; margin:0 auto;}
	.review .dogView table{width:100%; border-collapse: collapse;}
	.review .dogView table tr:nth-child(1){border-top:1px solid #333; border-bottom:1px solid #ccc;}
	.review .dogView table tr{font-size:16px; border-bottom:1px solid #ccc;}
	.review .dogView table tr th{background-color:#efefef; width:20%; padding:1% 0; text-align:center;}
	.review .dogView table tr td{width:30%; padding:1% 0 1% 2%;}
	...
	.modal-body p{width:90%; text-align:center; background-color:#efefef; margin:0 auto; margin-top:20px; padding:5% 0;}
	...
	@media screen and (max-width:768px){
		...
		.review .dogView{width:100%;}
		.review .dogView table tr{font-size:14px;}
		.review .dogView table tr th{background-color:#efefef; width:20%; padding:2% 0;}
		.review .dogView table tr:nth-child(5) td{padding:2% 2%;}
			...
			<div class="content">
				<div class="review">
					...
					<div class='dogView'>
						...
						<!-- 목록 버튼 -->
						<div class='button'>
							<input type='button' value='입양신청' data-target='#myModal' data-toggle='modal'/>
							<input type='button' value='목록' onClick="location.href='../dog/01.html'"/>
						</div>
					</div>
						...
						<div class='modal-dialog modal-sm'>
							<div class='modal-content'>
								...
								<div class='modal-footer'>
									<button class='btn btn-default' data-dismiss='modal' id='adoptReserve'>신청하기</button>
